  ...
  return (
    ...
    >
      <div className="bg-black px-2 bg-opacity-30 h-full w-full flex flex-col justify-center items-center text-white">
        <h1 className="text-5xl max-lg:text-4xl font-bold my-5">ABOUAT US</h1>
        ...
        <div className="text-2xl max-lg:text-xl leading-10 font-light md:px-20 text-center">
          At Reayah, we are committed to revolutionizing the way patients access
          healthcare services. Our platform seamlessly integrates various
          features to enhance patient-doctor interactions, streamline
          administrative tasks, and prioritize patient well-being.
        </div>
      </div>
    </div>
  );
