...
function OverviewCard({ title, Description, image, bgColor, color, number }) {
  return (
    <div className=" flex  w-64 h-52 gap-5 py-5 mt-2.5 max-md:flex-wrap max-md:max-w-full">
      <div
      ...
      >
        <div className="flex gap-2.5 text-base  leading-6 text-violet-700">
          <img
            ...
            className="shrink-0 w-16 p-2 h-16 rounded-full aspect-square"
          />
          <div>
          ...
          <div className="self-end mt-5 text-xs text-purple-500">
            {Description}
          </div>
        </div>
      </div>
